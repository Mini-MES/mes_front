...
- [x] **Task 4**: `src/components/common/notification/NotificationDrawer.tsx` 및 헤더 🔔 아이콘 연동
- [x] **Task 5**: `src/hooks/useSignalRListener.ts` 수정 - SignalR 수신 시 `addNotification` 연동
